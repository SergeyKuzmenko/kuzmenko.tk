<template>
    <div class="page page-cv">
        ...
        <v-dialog adaptive="true" resizable="true"/>
            ...
            <main class="page cv-page">
                <section class="cv-block block-intro ">
                    <div class="container" style="margin-top: -100px; margin-bottom: -50px;">
                        ...
                        <p>Hello! I am <strong>Sergey</strong>. I work as interface and front end developer. I have
                    ...
                    <div class="container">
                        ...
                        <div class="hobbies group" id="hobbies">
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="text-center text-muted">Lorem ipsum dolor sit amet, consectetur
                                            adipiscing elit. Cras risus ligula, iaculis ut metus sit amet, luctus
                                            pharetra mauris. Aliquam purus felis, pretium vel pretium vitae, dapibus
                ...
                <footer class="page-footer">
                    <div class="container">
                        <div class="social-icons">
                            <a href="https://facebook.com/kuzmenko.tk"><i class="ion-social-facebook"
                                                                          title="Facebook"></i></a>
                            <a href="https://www.instagram.com/sergey__kuzmenko/"><i
                                    class="ion-social-instagram-outline" title="Instagram"></i></a>
                            <a href="https://twitter.com/KuzmenkoSA"><i class="ion-social-twitter" title="Twitter"></i></a>
                        </div>
                    </div>
                </footer>
            </main>
